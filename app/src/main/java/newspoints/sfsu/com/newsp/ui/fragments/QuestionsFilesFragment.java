...
public class QuestionsFilesFragment extends BaseFragment {
    private static Context activityContext;
    final String eventType = "question";
    ...
    public static QuestionsFilesFragment newInstance(String text,
                                                     Context context) {
        activityContext = context;
        QuestionsFilesFragment f = new QuestionsFilesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.project_file_list_fragment, container, false);
        ...
        temp = prefs.getStringSet(categoryName + "question", null);
        j = temp.iterator();
        if (j == null) {
            ...
            if (projectId == null) {
                ...
                adapter = new FilesListAdapter(activityContext, projectId,
                        recordingId, endTime, eventId, type, imageUri,
                        createdDate, projectName);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ProjectConstants.dbClass.getFilesList(ProjectConstants.selectedProjectName, QuestionsFilesFragment.this);
        ...
        // set on long click listener for list
