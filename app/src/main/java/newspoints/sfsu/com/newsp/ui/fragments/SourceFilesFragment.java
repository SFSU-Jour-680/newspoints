...
public class SourceFilesFragment extends BaseFragment {
    private static Context activityContext;
    final String eventType = "source";
    ...
    public static SourceFilesFragment newInstance(String text, Context context) {
        activityContext = context;
        SourceFilesFragment f = new SourceFilesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prefs = activityContext.getSharedPreferences(
                activityContext.getPackageName(), Context.MODE_PRIVATE);
        ...
        temp = prefs.getStringSet(categoryName + "source", null);
        try {
            j = temp.iterator();
        ...
        ProjectConstants.dbClass.getFilteredFilesList(selectionArg,
                ProjectConstants.selectedProjectName, SourceFilesFragment.this);
        ...
        actionB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addProjectFiles = new Intent(activityContext, VideoCaptureActivity.class);
        ...
        actionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                addProjectFiles = new Intent(activityContext, AudioRecorderActivity.class);
                addProjectFiles.putExtra("foldername", ProjectConstants.selectedProjectName);
                startActivity(addProjectFiles);
                ((Activity) activityContext).finish();
            }
        });
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ProjectConstants.dbClass.getFilesList(ProjectConstants.selectedProjectName, SourceFilesFragment.this);
